  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/earlydance-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/earlydance-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build earlydance-style-guide.gemspec && mv earlydance-style-guide-' + userConfig.client.version + '.gem ../earlydance-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install earlydance-style-guide-' + userConfig.client.version + '.gem && rm earlydance-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
